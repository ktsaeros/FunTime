<#
.SYNOPSIS
    Aeros IT Forensic Health Audit (v5.4)
    - FIXED: Rounding logic for Sleep/Monitor timeouts (No more 0.01666).
    - IMPROVED: "Managed/Hidden" label for blank GPO settings.
    - IMPROVED: User Audit clarifies Domain Group membership limits.
#>
