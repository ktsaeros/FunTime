...
function Get-UserProfileAdminStatus {
    <# 
    .SYNOPSIS
        Lists user profiles, whether each is Local/Domain/Workgroup, and if they're in the local Administrators group (Yes/No/Unknown).
    #>
    ...
    # Export (optional): Uncomment if you want to export instead of just display
